...
//     src: '/gallery/6.webp',
//     title: 'Research Labs',
//     subtitle: 'Innovation & discovery hub',
//     category: 'Labs',
//     span: 'col-span-1 row-span-1'
//   }
];
    ...
    <div className="min-h-screen bg-black py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 auto-rows-[280px]">
          {galleryItems.map((item) => (
            ...
            >
              ...
              {/* Category Badge */}
              <div className={`absolute top-4 right-4 bg-red-600 backdrop-blur-md px-4 py-1.5 rounded-full border border-red-500 transition-all duration-500 ${
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 transform transition-all duration-500">
                <div className={`transition-all duration-500 ${
                  hoveredId === item.id ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-90'
                }`}>
                ...
                {/* View More Button */}
                <button className={`mt-4 bg-red-600 text-white px-6 py-2 rounded-full font-medium text-sm transition-all duration-500 transform hover:bg-red-700 hover:scale-105 ${
              ...
              <div className={`absolute top-0 left-0 w-16 h-16 border-l-2 border-t-2 border-red-600 transition-all duration-500 ${
                hoveredId === item.id ? 'opacity-100 scale-100' : 'opacity-0 scale-75'
              }`} />
              <div className={`absolute bottom-0 right-0 w-16 h-16 border-r-2 border-b-2 border-red-600 transition-all duration-500 ${
                hoveredId === item.id ? 'opacity-100 scale-100' : 'opacity-0 scale-75'
              }`} />
            </div>
          ))}
        ...
        <div className="text-center mt-16">
          <button className="bg-red-600 text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-red-700 transition-all duration-300 hover:scale-105 shadow-xl hover:shadow-2xl hover:shadow-red-600/50">
            Explore Our Campus
          </button>
        </div>
      </div>
